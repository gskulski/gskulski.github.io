...
<span style="position: absolute; left: 0; font-size: 1rem;">★</span>[Timothy E. Cook Best Graduate Student Paper Award, Political Communication Section, APSA 2026](https://apsanet.org/membership/organized-sections/organized-section-awards/past-awards/section-23/)
</div>
...
::: {.publication-entry}
**« Measuring Public Opinion and Political Behavior in the Digital Age: Promises and Limitations of Digital Trace Data. »** *Document de travail*. (Avec David G. Rand et Adam J. Berinsky)
:::
...
::: {.publication-entry}
**« The Unintended Consequences of Labeling AI-Generated Media Online. »** *Sous révision*. (Avec Kai Zhou, Adam J. Berinsky et David G. Rand). *Le preprint peut être consulté [ici](https://osf.io/preprints/psyarxiv/v87xf_v1)*.
...
::: {.publication-entry}
**« Does the Source of Content Authenticity Labels Matter? »** *Document de travail*. (Avec Inhwan Bae, David G. Rand et Adam J. Berinsky)
:::

::: {.publication-entry}
**« The Limits of AI-Persuasion: How Voters React to Synthetic Campaign Media. »** *Document de travail*. (Avec Victor Livernoche, Aarash Feizi, Svetlana Zhuk, Kellin Pelrine, André Blais, Reihaneh Rabbany et Jean-François Godbout)
:::
...
<div style="margin: 0.5rem 0 0.5rem 0; padding-left: 1.5rem; position: relative; font-weight: 600; color: #4A7B95; padding-top: 0.3rem; padding-bottom: 0.3rem; margin-top: 0.3rem;">
<span style="position: absolute; left: 0; font-size: 1rem;">★</span>[Finaliste – prix du meilleur article, Datasets and Benchmarks Track](https://kdd.org/awards/view/2025-sigkdd-best-paper-award-winners)
</div>
