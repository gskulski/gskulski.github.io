...
## Comportement politique en ligne
...
<span style="position: absolute; left: 0; font-size: 0.6rem;">●</span>[Timothy E. Cook Best Graduate Student Paper Award, Political Communication Section, APSA 2026](https://apsanet.org/membership/organized-sections/organized-section-awards/past-awards/section-23/)
</div>
...
::: {.publication-entry}
**« Measuring Public Opinion and Political Behavior in the Digital Age: Promises and Limitations of Digital Trace Data. »** *En cours*. (Avec David G. Rand et Adam J. Berinsky)
:::

## Intelligence artificielle et politique

::: {.publication-entry}
**« Labeling AI-Generated Media Online. »** 2025. *PNAS Nexus* 4(6). (Avec Chloe Wittenberg, Ziv Epstein, Adam J. Berinsky et David G. Rand). *L'article peut être consulté [ici](https://doi.org/10.1093/pnasnexus/pgaf170)*.
...
::: {.publication-entry}
**« The Unintended Consequences of Labeling AI-Generated Media Online. »** *Révision et resoumission à Nature Communications*. (Avec Kai Zhou, Adam J. Berinsky et David G. Rand). *Le preprint peut être consulté [ici](https://osf.io/preprints/psyarxiv/v87xf_v1)*.
...
::: {.publication-entry}
**« Does the Source of Content Authenticity Labels Matter? »** *En cours*. (Avec Inhwan Bae, David G. Rand et Adam J. Berinsky)
:::

::: {.publication-entry}
**« The Limits of AI-Persuasion: How Voters React to Synthetic Campaign Media. »** *En cours*. (Avec Victor Livernoche, Aarash Feizi, Svetlana Zhuk, Kellin Pelrine, André Blais, Reihaneh Rabbany et Jean-François Godbout)
:::

## Désinformation

::: {.publication-entry}
**« A Guide to Misinformation Detection Data and Evaluation. »** *Proceedings of the KDD Datasets and Benchmarks Track 2025*, Toronto, Canada, 3–7 août 2025. (Avec Camille Thibault, Jacob-Junqi Tian, Taylor Lynn Curtis, James Zhou, Florence Laflamme, Yuxiang Guan, Reihaneh Rabbany, Jean-François Godbout et Kellin Pelrine). *L'article peut être consulté [ici](https://dl.acm.org/doi/abs/10.1145/3711896.3737437)*.

<div style="margin: 0.5rem 0 0.5rem 0; padding-left: 1.5rem; position: relative; font-weight: 600; color: #4A7B95; padding-top: 0.3rem; padding-bottom: 0.3rem; margin-top: 0.3rem;">
<span style="position: absolute; left: 0; font-size: 0.6rem;">●</span>[Finaliste – prix du meilleur article, Datasets and Benchmarks Track](https://kdd.org/awards/view/2025-sigkdd-best-paper-award-winners)
</div>
...
::: {.publication-entry}
**« A Double-Edged Sword: Unpacking the Relationship between Political Sophistication and Belief in Political (Mis)Information. »** *Révision et resoumission à Political Behavior*. (Avec Chloe Wittenberg, Adam J. Berinsky, Gordon Pennycook et David G. Rand)
...
## Élections et opinion publique

::: {.publication-entry}
**« Party Preference Representation. »** 2022. *Party Politics* 28(1). 48–60. (Avec André Blais, Eric Guntermann, Vincent Arel-Bundock, Ruth Dassonneville et Jean-François Laslier). *L'article peut être consulté [ici](https://journals.sagepub.com/doi/full/10.1177/1354068820954631)*.
...
::: {.publication-entry}
**« What Are the Consequences of Snap Elections on Citizens' Voting Behavior? »** 2021. *Representation* 57(1). 95–108. (Avec Jean-François Daoust). *L'article peut être consulté [ici](https://doi.org/10.1080/00344893.2020.1804440)*.
...
::: {.publication-entry}
**« What Do Voters Do When They Prefer a Leader From Another Party? »** 2021. *Party Politics* 27(2). (Avec Jean-François Daoust et André Blais). *L'article peut être consulté [ici](https://doi.org/10.1177/1354068819845100)*.
...
::: {.publication-entry}
**« Do (many) voters like ranking? »** 2021. *Party Politics* 27(6). 1223–1228. (Avec André Blais, Carolina Plescia et John Högström). *L'article peut être consulté [ici](https://doi.org/10.1177/1354068820945156)*.
...
::: {.publication-entry}
**« Logarithmic versus Linear Visualizations of COVID-19 Cases Do Not Affect Citizens' Support for Confinement. »** 2020. *Canadian Journal of Political Science* 53. 385–390. (Avec Semra Sevi, Marco Mendoza Aviña, Emmanuel Heisbourg, Paola Vegas, Maxime Coulombe, Vincent Arel-Bundock, Peter John Loewen et André Blais). *L'article peut être consulté [ici](https://doi.org/10.1017/S000842392000030X)*.
:::

::: {.publication-entry}
**« What is the Cost of Voting? »** 2019. *Electoral Studies* 59. 145–157. (Avec André Blais, Jean-François Daoust et Ruth Dassonneville). *L'article peut être consulté [ici](https://doi.org/10.1016/j.electstud.2019.02.011)*.
