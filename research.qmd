...
::: {.publication-entry}
**The Unintended Consequences of Labeling AI-Generated Media Online** Gabrielle Péloquin-Skulski, Kai Zhou, Ziv Epstein, Adam J. Berinsky, and David G. Rand. *Preprint can be accessed [here](https://osf.io/preprints/psyarxiv/v87xf_v1)*.
...
::: {.publication-entry}
**Labeling AI-Generated Media Online** Chloe Wittenberg, Ziv Epstein, Gabrielle Péloquin-Skulski, Adam J. Berinsky, and David G. Rand. 2025. *PNAS Nexus*. *Paper can be accessed [here](https://doi.org/10.1093/pnasnexus/pgaf170)*.
...
::: {.publication-entry}
**Party Preference Representation** André Blais, Eric Gunternmann, Vincent Arel-Bundock, Ruth Dassonneville, Jean-François Laslier, and Gabrielle Péloquin-Skulski. 2022. *Party Politics*. *Paper can be accessed [here](https://journals.sagepub.com/doi/full/10.1177/1354068820954631)*.
...
::: {.publication-entry}
**What Are the Consequences of Snap Elections on Citizens' Voting Behavior?** Jean-François Daoust and Gabrielle Péloquin-Skulski. 2021. *Representation*. *Paper can be accessed [here](https://doi.org/10.1080/00344893.2020.1804440)*.
...
::: {.publication-entry}
**What Do Voters Do When They Prefer a Leader From Another Party?** Jean-François Daoust, André Blais, and Gabrielle Péloquin-Skulski. 2021. *Party Politics*. *Paper can be accessed [here](https://doi.org/10.1177/1354068819845100)*.
...
::: {.publication-entry}
**Do (many) voters like ranking?** André Blais, Carolina Plescia, John Högström, and Gabrielle Péloquin-Skulski. 2021. *Party Politics*. *Paper can be accessed [here](https://doi.org/10.1177/1354068820945156)*.
...
::: {.publication-entry}
**Logarithmic versus Linear Visualizations of COVID-19 Cases Do Not Affect Citizens' Support for Confinement** Semra Sevi, Marco Mendoza Aviña, Gabrielle Péloquin-Skulski, Emmanuel Heisbourg, Paola Vegas, Maxime Coulombe, Vincent Arel-Bundock, Peter John Loewen, and André Blais. 2020. *Canadian Journal of Political Science*. *Paper can be accessed [here](https://doi.org/10.1017/S000842392000030X)*.
:::

::: {.publication-entry}
**What is the Cost of Voting?** André Blais, Jean-François Daoust, Ruth Dassonneville, and Gabrielle Péloquin-Skulski. 2019. *Electoral Studies*. *Paper can be accessed [here](https://doi.org/10.1016/j.electstud.2019.02.011)*.
...
::: {.publication-entry}
**A Guide to Misinformation Detection Data and Evaluation** Camille Thibault, Jacob-Junqi Tian, Gabrielle Péloquin-Skulski, Taylor Lynn Curtis, James Zhou, Florence Laflamme, Yuxiang Guan, Reihaneh Rabbany, Jean-François Godbout, and Kellin Pelrine. 2025. *KDD Datasets and Benchmarks Track*. *Paper can be accessed [here](https://dl.acm.org/doi/abs/10.1145/3711896.3737437)*.
