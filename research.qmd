...
::: {.publication-entry}
**A Guide to Misinformation Detection Data and Evaluation** Camille Thibault, Jacob-Junqi Tian, Gabrielle Péloquin-Skulski, Taylor Lynn Curtis, James Zhou, Florence Laflamme, Yuxiang Guan, Reihaneh Rabbany, Jean-François Godbout, and Kellin Pelrine. *KDD Datasets and Benchmarks Track 2025*. *Paper can be accessed [here](https://dl.acm.org/doi/abs/10.1145/3711896.3737437)*.
