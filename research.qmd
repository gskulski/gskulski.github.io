...
::: {.publication-entry}
**The Unintended Consequences of Labeling AI-Generated Media Online.** *Revise and resubmit at Nature Communications*. (With Kai Zhou, Adam J. Berinsky, and David G. Rand). *Preprint can be accessed [here](https://osf.io/preprints/psyarxiv/v87xf_v1)*.
...
::: {.publication-entry}
**The Limits of AI-Persuasion: How Voters React to Synthetic Campaign Media.** *Working paper*. (With Victor Livernoche, Aarash Feizi, Svetlana Zhuk, Kellin Pelrine, André Blais, Reihaneh Rabbany, and Jean-François Godbout)
:::
...
<div style="margin: 0.5rem 0 0.5rem 0; padding-left: 1.5rem; position: relative; font-weight: 600; color: #4A7B95; padding-top: 0.3rem; padding-bottom: 0.3rem; margin-top: 0.3rem;">
<span style="position: absolute; left: 0; font-size: 0.6rem;">●</span>[Runner Up Best Paper Award, Datasets and Benchmarks Track](https://kdd.org/awards/view/2025-sigkdd-best-paper-award-winners)
</div>
